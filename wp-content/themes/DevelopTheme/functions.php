...
require_once get_template_directory() . '/inc/custom_login.php';
require_once get_template_directory() . '/inc/set_smtp_mail.php';
...
function ataStyles() {
    ...
    wp_enqueue_style('cameraStyles',get_template_directory_uri().'/assets/camera/camera-master/css/camera.css');
    wp_enqueue_style('mainStyles',get_template_directory_uri().'/style.css');
    wp_enqueue_script('jqueryEasing', get_theme_file_uri('/assets/camera/camera-master/scripts/jquery.easing.1.3.js'), array('jquery'), '1.0');
    wp_enqueue_script('jqueryMobile', get_theme_file_uri('/assets/camera/camera-master/scripts/jquery.mobile.customized.min.js'), array('jquery'), '1.0');
    wp_enqueue_script('camera', get_theme_file_uri('/assets/camera/camera-master/scripts/camera.min.js'), array('jqueryMobile', 'jqueryEasing'), '1.0');
