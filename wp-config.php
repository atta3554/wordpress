...
define( 'SMTP_HOST',     'mail.atacookies.ir' );
define( 'SMTP_USER',     '_mainaccount@atacookies.ir' );
define( 'SMTP_PASSWORD', 'Omiddimo3554@' );
define( 'SMTP_FROM',     '_mainaccount@atacookies.ir' );
define( 'SMTP_FROMNAME', 'Develop Theme' );
